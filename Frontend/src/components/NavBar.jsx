...
const NavBar = () => {
  ...
  return (
    <>
     <div className=" fixed top-0 left-0 right-0 flex justify-between text-white font-poppins bg-black h-[70px] pt-[15px] pb-[15px] font-bold text-4xl pl-[20px]">Astro Nav
