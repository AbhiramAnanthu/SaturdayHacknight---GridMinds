...
const Asteroid = () => {
  return (
    ...
    <div class="bg-white bg-opacity-30 backdrop-blur-lg rounded-xl p-8 max-w-lg w-full">
        <h1 class="text-center text-white font-poppins text-4xl font-bold mb-6">Asteroid ID</h1>
        
        <ul class="space-y-4 text-white font-poppins text-lg">
            <li>
                <span class="font-semibold">Closest Approach Date:</span> <span class="text-gray-300">[Date Here]</span>
            </li>
            <li>
                <span class="font-semibold">Speed:</span> <span class="text-gray-300">[Speed Here]</span>
            </li>
            <li>
